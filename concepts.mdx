...
- Integrate Ditto with a translation management system (either using one of our existing [connections](https://app.dittowords.com/account/connections) or via our API)
